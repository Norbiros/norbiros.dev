  ...
  >
    ...
    <div class="flex flex-col justify-between flex-1 px-20 py-16">
      ...
      <div class="flex items-center gap-4">
        <div class="flex items-center justify-center size-9 rounded-lg bg-primary-400 text-2xl font-bold text-neutral-950">
          N
        </div>
        <span class="text-xl font-medium text-highlighted">Norbiros</span>
        <div class="h-px flex-1 bg-border" />
        <span class="text-xl text-dimmed">norbiros.dev</span>
      </div>
    </div>
  </div>
</template>
